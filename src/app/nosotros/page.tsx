      ...
      <main>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24 w-full pb-20">
            <div className="max-w-3xl">
              <h1 className="font-heading text-white text-4xl sm:text-5xl lg:text-6xl xl:text-7xl leading-[1.02] tracking-tight mb-0">
                Innovación constante y el más alto estándar de calidad en revestimientos
              </h1>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24 py-24 lg:py-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              <div>
                ...
                <h2 className="font-heading text-2xl lg:text-3xl xl:text-4xl uppercase tracking-wide leading-tight mb-6">
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24 py-24 lg:py-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <h2 className="font-heading text-2xl lg:text-3xl xl:text-4xl uppercase tracking-wide leading-tight mb-6">
                  Materiales de la más alta calidad con acabados de lujo
                </h2>
                <p className="font-body text-white/55 text-[15px] leading-relaxed mb-8 max-w-md">
                  Somos apasionados por encontrar y ofrecer únicamente materiales de primera calidad.
                  Nuestros paneles y láminas de PVC cuentan con acabados premium, son 100% impermeables
                  y tienen la durabilidad para transformar cualquier espacio por años.
                </p>
                <a
                  href="/catalogo"
                  className="font-body text-sm text-white/70 border-b border-white/25 hover:text-white hover:border-white pb-0.5 transition-all duration-200 inline-flex items-center gap-2"
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24 py-24 lg:py-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              <div>
                ...
                <h2 className="font-heading text-2xl lg:text-3xl xl:text-4xl uppercase tracking-wide leading-tight mb-6">
                  Instalación rápida y accesible para cualquier proyecto
                </h2>
                <p className="font-body text-white/55 text-[15px] leading-relaxed mb-8 max-w-md">
                  Creemos que renovar tu hogar no debe ser complicado. Nuestros productos están diseñados
                  para una instalación DIY sencilla y rápida, sin necesidad de obra mayor.
                  Transformar tus espacios nunca había sido tan fácil y asequible.
                </p>
                <a
                  href={waUrl("Hola, quisiera más información sobre instalación de productos")}
                  target="_blank"
        ...
        <section className="py-20 lg:py-28 bg-brand-surface">
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
              ...
              {/* Info */}
              <div>
                <p className="font-body text-xs uppercase tracking-[0.2em] text-brand-orange mb-3">Visítanos</p>
                ...
                <p className="font-body text-brand-muted text-base leading-relaxed mb-10">
                  Visita nuestra tienda en Miami y descubre de primera mano la amplia selección de
                  revestimientos que tenemos para ti. Nuestro equipo está listo para asesorarte y
                  ayudarte a encontrar la solución perfecta para tu proyecto.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <a
                    href={waUrl("Hola, quisiera agendar una visita al showroom")}
                    target="_blank"
                    rel="noopener noreferrer"
        ...
        <section className="py-20 bg-white border-t border-brand-border">
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24">
            <div className="text-center mb-14">
              <p className="font-body text-xs uppercase tracking-[0.2em] text-brand-orange mb-3">Nuestros pilares</p>
              <h2 className="font-heading text-3xl lg:text-4xl uppercase tracking-wide text-brand-dark">
                Nuestro Propósito y Aspiración
              </h2>
              <p className="mt-4 font-body text-brand-muted text-base max-w-xl mx-auto leading-relaxed">
                Convertir espacios comunes en obras de diseño, liderando el mercado de revestimientos en el sur de Florida.
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                {
                  num: "01",
                  title: "100% Impermeabilidad",
                  desc: "Todos nuestros productos son completamente impermeables, ideales para baños, cocinas y exteriores.",
                },
                {
                  num: "02",
                  title: "Acabado Premium",
                  desc: "Diseños de lujo que elevan cualquier espacio, con texturas y terminaciones de primer nivel.",
                },
                {
                  num: "03",
                  title: "Instalación Rápida",
                  desc: "Sistemas DIY de fácil instalación que permiten renovar espacios en horas, sin obra mayor.",
                },
                {
                  num: "04",
                  title: "Resistencia y Durabilidad",
                  desc: "Materiales de alta durabilidad que mantienen su apariencia impecable ante el uso diario y el tiempo.",
                },
              ].map((v) => (
                <div
                  key={v.num}
        ...
        <section className="py-24 bg-brand-surface border-t border-brand-border">
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24 text-center">
            <p className="font-body text-xs uppercase tracking-[0.2em] text-brand-orange mb-4">Contáctanos</p>
            <h2 className="font-heading text-3xl sm:text-4xl xl:text-5xl uppercase tracking-tight text-brand-dark leading-[1.08] mb-6">
              ¿Listo para transformar<br className="hidden sm:block" /> tu hogar?
            </h2>
            <p className="font-body text-brand-muted text-base max-w-xl mx-auto leading-relaxed mb-10">
              Cotiza gratis con nuestros expertos y descubre cómo llevar el diseño de lujo a cada rincón de tus espacios.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={waUrl("Hola, me interesa conocer más sobre sus productos")}
                target="_blank"
                rel="noopener noreferrer"
