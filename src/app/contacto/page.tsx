...
export const metadata: Metadata = {
  title: "Contacto",
  description:
    "Contáctanos para cotizaciones, asesoría técnica o cualquier consulta sobre nuestros revestimientos premium en Miami, FL.",
};
        ...
        <section className="relative bg-brand-footer pt-28 pb-16 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24">
            <nav className="flex items-center gap-2 mb-8" aria-label="Breadcrumb">
              <a href="/" className="font-body text-[10px] uppercase tracking-widest text-white/40 hover:text-white/70 transition-colors duration-200">
                Inicio
              </a>
              <span className="text-white/25 text-[10px]">/</span>
              <span className="font-body text-[10px] uppercase tracking-widest text-brand-orange">Contacto</span>
            </nav>
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
              ...
              <p className="font-body text-white/50 text-sm max-w-xs lg:text-right leading-relaxed pb-1">
                Cotización gratuita, asesoría personalizada y respuesta en minutos por WhatsApp.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-brand-surface py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
              ...
              {/* Left: contact info */}
              <div>
                <p className="font-body text-xs uppercase tracking-[0.2em] text-brand-orange mb-3">Información de contacto</p>
                ...
                <p className="font-body text-brand-muted text-base leading-relaxed mb-10">
                  Si tienes preguntas sobre nuestros revestimientos, necesitas asesoría técnica
                  o deseas cotizar un proyecto, estamos aquí para ayudarte.
                </p>
              ...
              <div>
                <div className="bg-white border border-brand-border p-8 lg:p-10">
                  <p className="font-body text-xs uppercase tracking-[0.2em] text-brand-orange mb-2">Formulario de contacto</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div>
                ...
                <p className="font-body text-brand-muted text-base leading-relaxed mb-8">
                  Visita nuestra tienda y descubre de primera mano la amplia selección de
                  revestimientos que tenemos para ti. Nuestro equipo te asesorará para
                ...
                <div className="space-y-2 mb-8">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-1 h-1 rounded-full bg-brand-orange" />
                    <span className="font-body text-brand-muted text-sm">Lunes – Sábado: 9:00 AM – 5:00 PM</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-1 h-1 rounded-full bg-brand-orange" />
                    <span className="font-body text-brand-muted text-sm">Domingos: 9:00 AM – 3:00 PM</span>
                  </div>
                </div>
                <a
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24">
            <div className="flex flex-wrap justify-between gap-x-8 gap-y-8">
              {[
                ...
                { value: "USA", label: "Envíos a todo el país" },
